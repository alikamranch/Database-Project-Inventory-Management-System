...
public class DeleteSuppliers extends JFrame {
	...
	public DeleteSuppliers() {
		...
		lblDeleteFromSuppliers.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblDeleteFromSuppliers.setBounds(199, 11, 257, 14);
		contentPane.add(lblDeleteFromSuppliers);
		
		JLabel lblEnterTheSupplier = new JLabel("Enter the supplier ID and the name of the supplier you want to delete from the supplier list");
		lblEnterTheSupplier.setFont(new Font("Tahoma", Font.BOLD, 12));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
		            ...
		            String sql="Delete from Suppliers where s_id='"+(sid.getText()+"';");
		            PreparedStatement pst = con.prepareStatement(sql);
		            pst.executeUpdate();
		            JOptionPane.showMessageDialog(null, (sid.getText())+" deleted from the Supplier list!");
		            int choose=0;
